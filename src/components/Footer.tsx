...
export default function Footer() {
    return (
        <footer className="bg-hems-blue text-white pt-16 pb-8 border-t border-hems-blue-light/20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400">
                            <li><Link href="/about" className="hover:text-hems-blue-light transition-colors">About Us</Link></li>
                            <li><Link href="/#services" className="hover:text-hems-blue-light transition-colors">Our Services</Link></li>
                            <li><Link href="/gallery" className="hover:text-hems-blue-light transition-colors">Gallery</Link></li>
                            <li><Link href="/contact" className="hover:text-hems-blue-light transition-colors">Contact</Link></li>
                        </ul>
                    </div>
                ...
                <div className="pt-8 border-t border-hems-blue-light/10 text-center text-gray-400 text-sm">
